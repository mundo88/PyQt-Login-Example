...
"}")
        ...
        self.valorant_logo = QLabel(Form)
        self.valorant_logo.setObjectName(u"valorant_logo")
        self.valorant_logo.setGeometry(QRect(168, 51, 66, 61))
        self.valorant_logo.setStyleSheet(u"border-image: url(:/resources/resources/VALORANT.png);")
